...
getStartedBtn[0].addEventListener("click", function(e) {
...
beforeWeBeginBtn[0].addEventListener("click", function(e) {
...
whyOneBtn[0].addEventListener("click", function(e) {
...
whyTwoBtn[0].addEventListener("click", function(e) {
...
whyThreeBtn[0].addEventListener("click", function(e) {
...
whyFourBtn[0].addEventListener("click", function(e) {
...
whyFiveBtn[0].addEventListener("click", function(e) {
